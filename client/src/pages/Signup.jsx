...
import { Mail, Lock, Eye, EyeOff, User, AlertCircle, Loader } from 'lucide-react';
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <User className={`w-5 h-5 ${isDark ? 'text-gray-500' : 'text-slate-gray'}`} />
                  </div>
                  <input
                    type="text"
                    value={name}
              ...
              <div>
                ...
                <p className={`mt-1 text-xs ${isDark ? 'text-gray-500' : 'text-slate-gray'}`}>
